...
{
    cs_select();
    spi_write_blocking(SPI_PORT, headerBuffer, headerLength);
    spi_write_blocking(SPI_PORT, bodyBuffer, bodyLength);
    cs_deselect();
    return 0;
}
                ...
                uint8_t       * readBuffer)
{
    cs_select();
    spi_write_blocking(SPI_PORT, headerBuffer, headerLength);
    spi_read_blocking(SPI_PORT, 0, readBuffer, readLength);
    cs_deselect();
    return 0;
}
...
{   
    ...
    spi_write_blocking(SPI_PORT, tx_buf, len);
